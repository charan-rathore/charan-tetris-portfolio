...
export function McpHero() {
  return <div className="mcp-console">
    ...
    <div className="mcp-output"><span>A MAP OF THE WORK</span><p>Pick a star for the whole story, or click the central Tetris piece for GitHub. The full galaxy connects every chapter.</p><Link href="/galaxy">EXPLORE THE FULL GALAXY ↗</Link></div>
