...
export const projects: Project[] = [
  {
    ...
    title: "IntelliRAG",
    copy: "Answers need receipts. Trace the passage, test the claim, and refuse when the docs fall short.",
  ...
  },
  {
    ...
    title: "memoRABLE",
    copy: "Six memory blocks. Every useful line stays linked to its source.",
  ...
  },
  {
    ...
    copy: "Forecasts meet rooftop truth. Bias checks and a leaderboard show what holds up.",
  ...
  },
  {
    ...
    copy: "A shared board for the messy middle: drag, decide, move.",
  ...
  },
  {
    ...
    copy: "Agent research with a visible confidence check, not a mystery verdict.",
  ...
  },
  {
    ...
    copy: "Drone footage into blackbuck detections. Computer vision with a field job.",
  ...
  },
  {
    ...
    copy: "Generate the shape and its label together. 1,000+ bolts ready for CAD ML.",
